...
/*
chall_manual_no int AI PK 
chall_no int 
mem_no int 
chall_ing_status int 
start_date datetime 
final_date datetime 
chall_result char(1)
*/
public class MemberChallStatus {
	...
	//생성자
	public MemberChallStatus(int chall_manual_no, int chall_no, int mem_no, int chall_ing_status, Date start_date, Date final_date, String chall_result) {
	...
	public String toString() {
		return "MemberChallStatus [chall_manual_no=" + chall_manual_no + ", chall_no=" + chall_no + ", mem_no=" + mem_no
